...
class KeyManager(Protocol):
    ...
    def get_key(self, _uid: bytes, key_no: int) -> bytes:
...
class UniqueKeyManager:
    ...
    def __init__(self, master_key: bytes):
        ...
        raise NotImplementedError(
            "UniqueKeyManager not yet implemented. Use SimpleKeyManager for now."
        )
...
def create_key_manager(
    use_unique_keys: bool = False, master_key: bytes = KEY_DEFAULT_FACTORY
) -> KeyManager:
