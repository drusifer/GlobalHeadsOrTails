...
- `class AccessRights` (Line 170)
  ...
  > Byte 0 [3:0]: Change access (ChangeFileSettings)
    - `def __post_init__` (Line 184)
      > Convert int values to AccessRight enums if needed.
    - `def to_bytes` (Line 191)
      > Convert to NTAG424 2-byte format.
    - `def from_bytes` (Line 198)
      > Parse from 2-byte format.
    - `def __str__` (Line 212)
- `class AccessRightsPresets` (Line 225)
  > Common access rights configurations.
- `class CommMode` (Line 261)
  ...
  > Stored in bits [1:0] of FileOption byte.
    - `def requires_auth` (Line 271)
      > Check if this mode requires authentication.
    - `def from_file_option` (Line 276)
      > Extract CommMode from FileOption byte (bits [1:0]).
    - `def __str__` (Line 280)
- `class SDMOption` (Line 288)
  > SDM configuration options (bit flags).
  > Can be combined using bitwise OR: SDMOption.ENABLED | SDMOption.UID_MIRROR
- `class NdefUriPrefix` (Line 309)
  > NDEF URI identifier codes.
    - `def __str__` (Line 323)
    - `def to_prefix_string` (Line 326)
      > Convert prefix code to actual URL prefix string.
- `class NdefRecordType` (Line 344)
  > NDEF Record Type Name Format (TNF).
    - `def __str__` (Line 355)
- `class NdefTLV` (Line 359)
  > NDEF TLV types for Type 4 Tags.
    - `def __str__` (Line 368)
- `class MemorySize` (Line 376)
  > Standard memory sizes for NTAG424 DNA variants.
- `class ApplicationID` (Line 386)
  > Application IDs for NTAG424 DNA.
- `class ErrorCategory` (Line 395)
  > Categories of errors for better error handling.
    - `def __str__` (Line 406)
- `def get_error_category` (Line 439)
  > Get error category for a status word.
- `class SuccessResponse` (Line 449)
  > Response for successful operations.
    - `def __str__` (Line 453)
- `class AuthenticationChallengeResponse` (Line 458)
  > Response from EV2 authentication first phase.
    - `def __str__` (Line 463)
- `class AuthenticationResponse` (Line 468)
  > Response from EV2 authentication second phase.
    - `def __str__` (Line 475)
- `class Ntag424VersionInfo` (Line 483)
  > Version information from NTAG424 DNA chip.
    - `def __str__` (Line 504)
- `class ReadDataResponse` (Line 529)
  > Response from file read operations.
    - `def __str__` (Line 537)
- `class FileOption` (Line 545)
...
- `class CCFileData` (Line 835)
  ...
  > what access conditions apply.
    - `def from_bytes` (Line 869)
      > Parse CC file data from raw bytes.
    - `def to_bytes` (Line 921)
...
- `class SeritagSimulator` (Line 62)
  > Simulates a Seritag NTAG424 DNA tag.
    ...
    - `def _handle_select_application` (Line 129)
      > Handle Select PICC Application command.
    - `def _handle_get_version` (Line 134)
      > Handle Get Chip Version command according to NTAG424 DNA specification.
    - `def _handle_authenticate_ev2_first` (Line 197)
      > Handle AuthenticateEV2First command with proper EV2 implementation.
    - `def _handle_authenticate_ev2_second` (Line 227)
      > Handle AuthenticateEV2Second command with proper EV2 implementation.
    - `def _handle_select_file` (Line 285)
      > Handle Select File command.
    - `def _handle_update_binary` (Line 302)
      > Handle Update Binary command.
    - `def _handle_change_file_settings` (Line 324)
      > Handle ChangeFileSettings command.
    - `def _handle_change_key` (Line 341)
      > Handle ChangeKey command.
- `class SeritagCardConnection` (Line 357)
  > Simulated Seritag card connection.
    - `def __init__` (Line 360)
    - `def send_apdu` (Line 363)
      > Send APDU to simulated Seritag tag.
    - `def send` (Line 368)
      > Support for high-level Command objects (like NTag424CardConnection.send).
    - `def transmit` (Line 389)
      > Alias for send_apdu to match pyscard interface.
    - `def control` (Line 393)
      > Simulate control command (for escape sequences).
- `class SeritagCardManager` (Line 400)
  > Simulated card manager for Seritag tags.
    - `def __init__` (Line 403)
    - `def __enter__` (Line 408)
      > Context manager entry.
    - `def __exit__` (Line 416)
      > Context manager exit.

## `src/ntag424_sdm_provisioner/services/diagnostics_service.py`
- `class TagDiagnosticsService` (Line 16)
...
- `class NtagProvisionerApp` (Line 13)
  > A Textual app for NTAG424 DNA Provisioning.
    - `def on_mount` (Line 54)
    - `def action_switch_mode` (Line 61)
...
## `src/ntag424_sdm_provisioner/tui/commands/tag_status_command.py`
- `class TagStatusCommand` (Line 13)
  > Check tag status (Factory vs Provisioned).
    - `def __init__` (Line 16)
    - `def timeout_seconds` (Line 20)
    - `def operation_name` (Line 24)
    - `def execute` (Line 27)
...
- `class ServiceAdapter` (Line 14)
  > Adapts ProvisioningService to WorkerManager protocol.
    - `def __init__` (Line 16)
    - `def timeout_seconds` (Line 22)
    - `def execute` (Line 25)
      > Execute provisioning via service.
- `class ProvisionScreen` (Line 42)
  > Screen for provisioning a tag.
    - `def compose` (Line 45)
    - `def on_mount` (Line 56)
    - `def on_unmount` (Line 69)
    - `def on_button_pressed` (Line 73)
    - `def start_provisioning` (Line 77)
    - `def on_worker_state_changed` (Line 93)
...
## `src/ntag424_sdm_provisioner/tui/screens/tag_status.py`
- `class TagStatusScreen` (Line 13)
  > Screen for checking tag status (Factory vs Provisioned).
    - `def compose` (Line 16)
    - `def on_mount` (Line 28)
    - `def on_unmount` (Line 41)
    - `def on_button_pressed` (Line 45)
    - `def scan_tag` (Line 51)
    - `def on_worker_state_changed` (Line 63)
