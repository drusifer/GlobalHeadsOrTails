...
def main():
    parser = argparse.ArgumentParser(description="Append a short message to agents/CHAT.md.  For a longer messages create an md doc with the details and then send a chat telling everyone where to find it.")
    ...
    if len(message) > 256:
        raise ValueError("Message must be less than 256 characters.  Please create a summary doc and then post about it instead.")
